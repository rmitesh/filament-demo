...
use App\Filament\StoreManager\Resources\OrderResource\Pages;
use App\Filament\StoreManager\Resources\OrderResource\RelationManagers;
use App\Filament\StoreManager\Resources\OrderResource\Widgets\OrderStats;
        ...
        return Forms\Components\Repeater::make('items')
            ...
            ->extraItemActions([
                Forms\Components\Actions\Action::make('openProduct')
                    ...
                    ->hidden(fn (array $arguments, Forms\Components\Repeater $component): bool => blank($component->getRawItemState($arguments['item'])['shop_product_id'])),
            ])
            ->orderColumn('sort')
            ->defaultItems(1)
            ->hiddenLabel()
